...
# Temporary: Use explicit path to the Firebase Admin SDK JSON file
firebase_sdk_path = r'C:\Users\מאיר\Desktop\shoping\shop\shop-449e4-firebase-adminsdk-p5bza-71f4c1f6f2.json'

if not os.path.exists(firebase_sdk_path):
    raise ValueError(f"Firebase Admin SDK file not found at: {firebase_sdk_path}")
